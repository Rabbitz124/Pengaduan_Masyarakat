    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            ...
            <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                ...
                <a class="flex-sm-fill text-sm-center nav-link" id="belum-tab" data-bs-toggle="tab" href="#belum"
                    role="tab" aria-controls="belum" aria-selected="false">belum</a>
                <a class="flex-sm-fill text-sm-center nav-link" id="proses-tab" data-bs-toggle="tab" href="#proses"
                    role="tab" aria-controls="proses" aria-selected="false">Proses</a>
                <a class="flex-sm-fill text-sm-center nav-link" id="selesai-tab" data-bs-toggle="tab" href="#selesai"
                                        ...
                                        <tr>
                                            <td class="cell">
                                                ...
                                                <a class="badge bg-danger"
                                                    href="batalkan.php?id_pengaduan=<?php echo $row1['id_pengaduan'] ?>">Batalkan</a>
                                                <?php } else if ($status == 'proses') { ?>
                                                <span class="badge bg-warning">Diproses</span>
                                                <?php } else { ?>
                                                <span class="badge bg-success">Selesai</span>
                                                <a class="badge bg-secondary"
                                                    href="lihat_tanggapan_masyarakat.php?id_pengaduan=<?php echo $row1['id_pengaduan'] ?>">Lihat
                                                    Tanggapan</a>
                                                <?php } ?>
                                            </td>
                                            <td class="cell"><span
                                                    class="truncate"><?php echo $row1['tgl_pengaduan']; ?></span></td>
                                            <td class="cell"><?php echo $row1['isi_laporan']; ?></td>
                                            <td class="cell"><span><?php echo $row1['nik']; ?></span></td>
                                            <td class="cell"><img src="img\<?php echo $row1['foto']; ?>" height="100"
                                                    alt="Bukti"></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="cell">
                                                ...
                                                <span class="badge bg-secondary">Belum</span>
                                                <a class="badge bg-danger"
                                                    href="batalkan.php?id_pengaduan=<?php echo $row2['id_pengaduan'] ?>">Batalkan</a>
                                                <?php } else if ($status == 'proses') { ?>
                                                <span class="badge bg-warning">Diproses</span>
                                                <?php } else { ?>
                                                <span class="badge bg-success">Selesai</span>
                                                <a class="badge bg-secondary"
                                                    href="lihat_tanggapan_masyarakat.php?id_pengaduan=<?php echo $row2['id_pengaduan'] ?>">Lihat
                                                    Tanggapan</a>
                                                <?php } ?>
                                            </td>
                                            <td class="cell"><span
                                                    class="truncate"><?php echo $row2['tgl_pengaduan']; ?></span></td>
                                            <td class="cell"><?php echo $row2['isi_laporan']; ?></td>
                                            <td class="cell"><span><?php echo $row2['nik']; ?></span></td>
                                            <td class="cell"><img src="img\<?php echo $row2['foto']; ?>" height="100"
                                                    alt="Bukti"></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="cell">
                                                ...
                                                <span class="badge bg-secondary">Belum</span>
                                                <a class="badge bg-danger"
                                                    href="batalkan.php?id_pengaduan=<?php echo $row3['id_pengaduan'] ?>">Batalkan</a>
                                                <?php } else if ($status == 'proses') { ?>
                                                <span class="badge bg-warning">Diproses</span>
                                                <?php } else { ?>
                                                <span class="badge bg-success">Selesai</span>
                                                <a class="badge bg-secondary"
                                                    href="lihat_tanggapan_masyarakat.php?id_pengaduan=<?php echo $row3['id_pengaduan'] ?>">Lihat
                                                    Tanggapan</a>
                                                <?php } ?>
                                            </td>
                                            <td class="cell"><span
                                                    class="truncate"><?php echo $row3['tgl_pengaduan']; ?></span></td>
                                            <td class="cell"><?php echo $row3['isi_laporan']; ?></td>
                                            <td class="cell"><span><?php echo $row3['nik']; ?></span></td>
                                            <td class="cell"><img src="img\<?php echo $row3['foto']; ?>" height="100"
                                                    alt="Bukti"></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="cell">
                                                ...
                                                <span class="badge bg-secondary">Belum</span>
                                                <a class="badge bg-danger"
                                                    href="batalkan.php?id_pengaduan=<?php echo $row4['id_pengaduan'] ?>">Batalkan</a>
                                                <?php } else if ($status == 'proses') { ?>
                                                <span class="badge bg-warning">Diproses</span>
                                                <?php } else { ?>
                                                <span class="badge bg-success">Selesai</span>
                                                <a class="badge bg-secondary"
                                                    href="lihat_tanggapan_masyarakat.php?id_pengaduan=<?php echo $row4['id_pengaduan'] ?>">Lihat
                                                    Tanggapan</a>
                                                <?php } ?>
                                            </td>
                                            <td class="cell"><span
                                                    class="truncate"><?php echo $row4['tgl_pengaduan']; ?></span></td>
                                            <td class="cell"><?php echo $row4['isi_laporan']; ?></td>
                                            <td class="cell"><span><?php echo $row4['nik']; ?></span></td>
                                            <td class="cell"><img src="img\<?php echo $row4['foto']; ?>" height="100"
                                                    alt="Bukti"></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
